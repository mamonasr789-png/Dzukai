...
function ai(prompt: string, seed: number) {
  return `https://image.pollinations.ai/prompt/${encodeURIComponent(prompt + ", professional food photography, restaurant dish, dark moody background, high quality")}?width=800&height=600&nologo=true&seed=${seed}&model=flux`;
}

const IMG = {
  // Starters
  herring:        ai("marinated herring fillet with pickled onions and hot boiled potatoes on elegant plate", 101),
  carpaccio:      ai("beef carpaccio thin raw sliced with capers parmesan arugula elegant plate", 102),
  tunaCarpaccio:  ai("tuna carpaccio thin sliced with sesame ginger sauce elegant plate", 103),
  // Salads
  beet:           ai("roasted beet salad feta cheese walnuts arugula elegant plate", 104),
  caesarChicken:  ai("caesar salad grilled chicken breast romaine lettuce parmesan croutons", 105),
  caesarShrimp:   ai("caesar salad grilled shrimp prawns romaine lettuce parmesan", 106),
  burrata:        ai("burrata cheese salad serrano ham cherry tomatoes basil olive oil", 107),
  salad:          ai("greek salad feta olives cucumber tomato red onion elegant bowl", 108),
  duck:           ai("duck breast salad orange segments honey mustard dressing arugula", 109),
  tunaSalad:      ai("fresh tuna fillet salad blueberries lemon dressing elegant plate", 110),
  // Soups
  soup:           ai("cold beet soup Lithuanian šaltibarščiai pink soup cucumber egg sour cream bowl", 111),
  sriuba:         ai("warm cabbage soup porcini mushrooms Lithuanian kopūstienė bowl rustic", 112),
  chiliSoup:      ai("spicy chili soup beef beans smoked peppers sour cream bowl", 113),
  tomyum:         ai("Thai tom yum soup shrimp mushrooms lemongrass coconut milk spicy bowl", 114),
  // Pancakes
  pancakes:       ai("thin crepe pancakes cottage cheese filling plate stack", 115),
  pancakesBanana: ai("thin crepe pancakes fresh bananas chocolate sauce plate", 116),
  pancakesHam:    ai("savory crepe pancakes ham melted cheese plate", 117),
  // Dumplings
  dumplings:      ai("Lithuanian potato dumplings koldūnai cottage cheese spinach sour cream plate", 118),
  gyoza:          ai("Japanese gyoza dumplings lamb soy sauce dipping sauce plate", 119),
  // Wok
  wok:            ai("wok stir fried noodles chicken vegetables Asian sauce bowl", 120),
  wokBeef:        ai("wok stir fried noodles beef vegetables dark soy sauce bowl", 121),
  wokDuck:        ai("wok stir fried noodles duck hoisin sauce vegetables bowl", 122),
  wokSeafood:     ai("wok stir fried noodles mixed seafood shrimp squid vegetables bowl", 123),
  wokRice:        ai("wok fried rice chicken vegetables Asian style bowl", 124),
  wokRiceBeef:    ai("wok fried rice beef vegetables dark soy sauce bowl", 125),
  wokRiceSeafood: ai("wok fried rice mixed seafood shrimp squid colorful bowl", 126),
  // Potato dishes
  potato:         ai("Lithuanian cepelinai zeppelin potato dumplings meat filling sour cream plate", 127),
  potatoPancake:  ai("crispy potato pancakes draniki stack sour cream rustic plate", 128),
  potatoBun:      ai("Lithuanian potato buns bulvinės bandos soft fluffy cracklings sour cream", 129),
  // Pizzas
  pizza:          ai("Margherita pizza wood fired fresh basil mozzarella tomato sauce", 130),
  pizzaVeg:       ai("vegetarian pizza seasonal vegetables pesto mozzarella wood fired", 131),
  pizza4cheese:   ai("four cheese pizza mozzarella gorgonzola parmesan wood fired oven", 132),
  pizzaKhachapuri:ai("Georgian khachapuri cheese bread egg boat shaped", 133),
  pizzaSalami:    ai("salami pizza pepperoni jalapeño mozzarella wood fired", 134),
  pizzaMeat:      ai("meat lovers pizza ham bacon salami minced meat wood fired", 135),
  pizzaTuna:      ai("tuna pizza fillet capers red onion mozzarella wood fired", 136),
  pizzaPulledBeef:ai("pulled beef pizza BBQ sauce caramelized onion mozzarella", 137),
  // Grill
  grill:          ai("mixed grill platter assorted meats steaks ribs chicken on wooden board", 138),
  grillFish:      ai("fish grill platter assorted grilled fish seafood elegant serving", 139),
  // Chicken
  wings:          ai("BBQ glazed chicken wings Buffalo sauce blue cheese dip plate", 140),
  chickenShashlik:ai("chicken thigh shashlik skewer grill flame charcoal", 141),
  schnitzel:      ai("chicken Wiener schnitzel breaded golden mashed potatoes elegant plate", 142),
  chickenKebab:   ai("chicken mince kebab skewer yogurt mint sauce plate", 143),
  chicken:        ai("grilled chicken breast fillet seasonal vegetables elegant plate", 144),
  chickenGlazed:  ai("glazed honey soy chicken fillet golden shiny plate restaurant", 145),
  duckBreast:     ai("duck breast medium rare caramelized pear blue cheese sauce plate", 146),
  halfChicken:    ai("grilled half chicken herbs lemon rustic wooden board", 147),
  // Pork
  porkBelly:      ai("BBQ glazed pork belly strips ribs smoky caramelized dark plate", 148),
  schnitzelPork:  ai("pork Wiener schnitzel breaded golden crispy lemon mashed potatoes", 149),
  porkShashlik:   ai("pork shashlik skewer charcoal grill flame smoky", 150),
  porkTenderloin: ai("pork tenderloin sliced herb sauce garlic elegant plate", 151),
  porkNeck:       ai("pork neck steak thick grill marks juicy plate", 152),
  porkTomahawk:   ai("pork tomahawk steak impressive bone-in thick grill marks plate", 153),
  porkRibs:       ai("full rack BBQ pork ribs smoky glazed caramelized falling off bone", 154),
  porchetta:      ai("Italian porchetta roasted pork belly roll crispy skin fennel garlic", 155),
  pork:           ai("roasted pork belly caramelized apples mashed potatoes elegant plate", 156),
  // Beef & lamb
  steak:          ai("beef entrecote steak Argentine medium rare herb butter grill marks plate", 157),
  steakSurf:      ai("surf and turf beef entrecote grilled shrimp prawns elegant plate", 158),
  lamb:           ai("lamb kebab skewer minced yogurt mint sauce Middle Eastern plate", 159),
  lambRack:       ai("lamb rack French trimmed rosemary sauce crushed potato elegant plate", 160),
  // Fish
  mackerel:       ai("grilled whole mackerel lemon butter vegetables elegant plate", 161),
  cod:            ai("baked cod fillet aioli sauce grilled vegetables elegant plate", 162),
  shrimp:         ai("grilled king prawns shrimp garlic chili parsley butter plate", 163),
  seabass:        ai("whole sea bass baked salt crust Mediterranean herbs elegant plate", 164),
  salmon:         ai("Atlantic salmon fillet steak lemon butter capers asparagus elegant plate", 165),
  tuna:           ai("seared tuna steak sesame crust Asian salad medium rare plate", 166),
  octopus:        ai("grilled octopus tentacles caramelized pineapple paprika oil herbs plate", 167),
  // Kids
  kids:           ai("kids meal happy plate chicken strips french fries colorful", 168),
  fries:          ai("golden crispy french fries ketchup kids plate", 169),
  kidsBlynai:     ai("thin small pancakes cherry sauce kids dessert plate cute", 170),
  // Beer snacks
  bread:          ai("garlic bread toasted crispy butter restaurant plate", 171),
  cheeseToast:    ai("hot melted cheese toast toasted bread rustic plate", 172),
  olives:         ai("mixed marinated olives bowl olive oil herbs premium", 173),
  camembert:      ai("grilled Camembert cheese strawberries blueberries honey plate", 174),
  snackPlatter:   ai("warm appetizer snack platter assorted starters wooden board restaurant", 175),
  mozzarellaSticks: ai("fried mozzarella sticks golden crispy marinara sauce plate", 176),
  calamari:       ai("crispy fried calamari rings lemon aioli dipping sauce plate", 177),
  jalapeno:       ai("crispy breaded jalapeno poppers plate restaurant snack", 178),
  onionRings:     ai("crispy golden onion rings stack restaurant plate", 179),
  cheese:         ai("crispy cheese puffs balls golden plate restaurant snack", 180),
  // Desserts
  napoleon:       ai("Napoleon mille-feuille layered puff pastry cake cream elegant plate", 181),
  cheesecake:     ai("ricotta cheesecake slice creamy light elegant plate restaurant", 182),
  applePie:       ai("Austrian apple strudel warm vanilla custard sauce elegant plate", 183),
  pavlova:        ai("Pavlova meringue cake fresh berries strawberries whipped cream elegant", 184),
  brownie:        ai("chocolate brownie warm scoop vanilla ice cream elegant dark plate", 185),
  icecream:       ai("vanilla ice cream scoop flavored sauce elegant bowl restaurant", 186),
  beerIcecream:   ai("vanilla ice cream beer syrup breadcrumbs unique dessert plate", 187),
  sorbet:         ai("lemon sorbet scoop elegant glass restaurant dessert", 188),
  coconutIce:     ai("coconut ice cream scoop tropical elegant bowl restaurant", 189),
  // Drinks
  lemonade:       ai("homemade lemonade glass strawberry coconut fresh mint ice restaurant", 190),
  lemonade2:      ai("grapefruit lemonade glass ice citrus slice fresh restaurant", 191),
  milkshake:      ai("thick creamy milkshake glass vanilla strawberry chocolate restaurant", 192),
  smoothie:       ai("green healthy smoothie glass fresh fruits vegetables restaurant", 193),
  coffee:         ai("cappuccino espresso latte coffee cup elegant restaurant table", 194),
  tea:            ai("herbal tea cup elegant restaurant sea buckthorn berries", 195),
  water:          ai("water pitcher glass elegant restaurant table", 196),
  juice:          ai("fresh squeezed orange juice glass restaurant elegant", 197),
  softdrink:      ai("Coca Cola Sprite soda glass ice restaurant table", 198),
  beer:           ai("craft lager beer mug glass golden foam pub restaurant", 199),
  beer2:          ai("dark craft stout porter beer glass foam pub restaurant", 200),
  beerTasting:    ai("beer tasting flight board multiple glasses craft brewery", 201),
  cocktail:       ai("elegant cocktail glass fresh garnish mint citrus bar restaurant", 202),
  cocktail2:      ai("tropical cocktail glass colorful umbrella bar restaurant", 203),
  mojito:         ai("mojito cocktail glass mint lime ice transparent bar", 204),
  aperol:         ai("Aperol Spritz cocktail orange glass ice prosecco bar", 205),
  espressoMartini:ai("espresso martini cocktail elegant glass coffee beans bar", 206),
  wine:           ai("red white wine glass elegant restaurant table bottle", 207),
  champagne:      ai("champagne prosecco sparkling wine glass bubbles elegant restaurant", 208),
  spirits:        ai("whiskey bourbon spirit glass ice cube elegant bar restaurant", 209),
  cider:          ai("apple cider glass golden bubbles fruit bar restaurant", 210),
  nonAlcBeer:     ai("non-alcoholic craft beer glass cold refreshing restaurant", 211),
};
...
export const products: Product[] = [
  ...
  { id: "lb2", name: "Lietiniai su bananais (2 vnt.)", description: "Ploni lietiniai blynai su šviežiais bananais ir šokoladiniu padažu.", price: 5.80, priceNote: "2 vnt. 5,80 € / 3 vnt. 7,90 €", image: IMG.pancakesBanana, category: "lietiniai", ingredients: ["Miltai", "Kiaušiniai", "Pienas", "Bananai", "Šokoladinis padažas"], allergens: ["Glitimas", "Pienas", "Kiaušiniai"] },
  { id: "lb3", name: "Lietiniai su kumpiu ir sūriu (2 vnt.)", description: "Sotūs lietiniai blynai su kumpiu ir ištirpusiu sūriu.", price: 6.80, priceNote: "2 vnt. 6,80 € / 3 vnt. 9,00 €", image: IMG.pancakesHam, category: "lietiniai", ingredients: ["Miltai", "Kiaušiniai", "Pienas", "Kumpio", "Sūris"], allergens: ["Glitimas", "Pienas", "Kiaušiniai"] },
  ...
  { id: "b3", name: "Žemaičių blynai", description: "Tradiciniai Žemaitijos bulviniai blynai su mėsa.", price: 7.50, priceNote: "Mažas 7,50 € / Didelis 9,90 €", image: IMG.potatoPancake, category: "bulviniai", ingredients: ["Bulvės", "Mėsa", "Svogūnai", "Grietinė"], allergens: ["Pienas"] },
  ...
  { id: "v9", name: "Glazūruotas grilyje keptas viščiukas", description: "Glazūruotas viščiukas, keptas ant grotelių su BBQ padažu.", price: 16.00, priceNote: "Pusė 16,00 € / Visas 27,00 €", image: IMG.halfChicken, category: "vistiena", ingredients: ["Viščiukas", "BBQ glazūra", "Česnakai", "Prieskoniai"], allergens: ["Soja"] },
  ...
  { id: "lim2", name: "Greipfrutų limonadas", description: "Gaivus namų gamybos greipfrutų limonadas.", price: 4.00, priceNote: "0,3l — 4,00 € / 1l — 9,90 €", image: IMG.lemonade2, category: "limonadai", ingredients: ["Greipfrutas", "Citrina", "Cukrus", "Vanduo"], allergens: [] },
