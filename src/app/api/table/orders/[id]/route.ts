...
export async function GET(
  ...
  try {
    ...
    const { estimatedMinutes, estimatedMinutesByGroup } = await estimateOrderEta(order);
    return Response.json({ ok: true, order, estimatedMinutes, estimatedMinutesByGroup });
  } catch {
