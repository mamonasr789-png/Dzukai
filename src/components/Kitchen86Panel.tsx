...
const TEXT: Record<StaffLang, Record<string, string>> = {
  lt: {
    ...
    empty86: "Visi patiekalai yra.",
    emptySearch: "Nerasta.",
    pickCategory: "Pasirinkite kategoriją.",
    emptyPreset: "Šioje grupėje nieko nėra.",
  },
  en: {
    title: "Unavailable — disable a dish",
    search: "Search name or category…",
    mark86: "Unavailable",
    undo: "Available",
    error: "Could not update.",
    already86: "Already unavailable",
    available: "In stock — tap Unavailable",
    empty86: "All dishes are in stock.",
